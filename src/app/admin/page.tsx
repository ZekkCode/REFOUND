      ...
      <aside className="w-64 bg-white text-zinc-600 flex flex-col justify-between shrink-0 min-h-screen border-r border-zinc-200 hidden md:flex">
        <div className="p-6 space-y-8">
          ...
          <nav className="space-y-1">
            <Link
              href="/admin"
              className="flex items-center space-x-3 px-4 py-3 bg-[#5EEAD4]/80 text-[#0B1633] font-extrabold text-sm rounded-xl transition-all shadow-sm"
            >
            ...
            >
              ...
              <span className="bg-[#FFB020] text-white px-2 py-0.5 rounded-full text-[9px] font-black">3</span>
            </Link>
            ...
            >
              ...
              <span className="bg-red-500 text-white px-2 py-0.5 rounded-full text-[9px] font-black">18</span>
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-3xl border border-zinc-150 shadow-[0_10px_35px_rgba(11,22,51,0.02)] flex flex-col justify-between space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="px-2.5 py-1 text-[9px] font-bold text-zinc-500 bg-zinc-50 border border-zinc-200 rounded-full">
                  In Storage
                </span>
              </div>
              <div className="space-y-1">
                <h3 className="text-4xl font-black text-[#0B1633] font-mono leading-none">
                  142
                </h3>
            ...
            <div className="bg-white p-6 rounded-3xl border border-zinc-150 shadow-[0_10px_35px_rgba(11,22,51,0.02)] flex flex-col justify-between space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="px-2.5 py-1 text-[9px] font-black text-amber-600 bg-amber-50 border border-amber-200 rounded-full uppercase tracking-wider">
                  Action Required
                </span>
              </div>
              <div className="space-y-1">
            ...
            <div className="bg-white p-6 rounded-3xl border border-zinc-150 shadow-[0_10px_35px_rgba(11,22,51,0.02)] flex flex-col justify-between space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="px-2.5 py-1 text-[9px] font-black text-[#12A99A] bg-teal-50 border border-teal-200 rounded-full tracking-wider">
                  This Week
                </span>
              </div>
              <div className="space-y-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pt-2">
            ...
            <div className="lg:col-span-7 bg-white p-6 sm:p-8 rounded-3xl border border-zinc-150 shadow-[0_10px_35px_rgba(11,22,51,0.02)] space-y-6">
              <div className="flex items-center justify-between border-b border-zinc-100 pb-4">
                ...
                <Link href="/admin/klaim" className="text-xs font-bold text-[#006F69] hover:underline">
                  View All
                </Link>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between gap-4 p-4 border border-zinc-100 hover:border-zinc-200 rounded-2xl transition-all">
                  <div className="flex items-center space-x-4">
                    ...
                    {/* Meta info */}
                    <div className="space-y-1">
                      <h4 className="font-extrabold text-sm text-[#0B1633] leading-tight">
                        MacBook Pro Charger
                      </h4>
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span className="px-2 py-0.5 text-[8px] font-black uppercase text-amber-600 bg-amber-50 rounded-full">
                          Awaiting Verif
                        </span>
                      </div>
                  ...
                  <Link
                    href="/admin/klaim"
                    className="px-4 py-2 bg-white border border-[#006F69] hover:bg-[#006F69]/5 text-[#006F69] font-bold text-xs rounded-xl transition-all"
                  >
                    Review
                  </Link>
                </div>
            ...
            <div className="lg:col-span-5 bg-white p-6 sm:p-8 rounded-3xl border border-zinc-150 shadow-[0_10px_35px_rgba(11,22,51,0.02)] space-y-6">
              <h3 className="text-lg font-black text-[#0B1633] flex items-center border-b border-zinc-100 pb-4">
                <svg className="w-5 h-5 mr-2 text-[#0B1633]" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
              ...
              <div className="relative pl-6 space-y-6">
                ...
                <div className="relative space-y-1">
                  ...
                  <h4 className="text-xs font-black text-[#0B1633]">
                    Item Returned
                  </h4>
                  <p className="text-zinc-500 text-[10px] font-semibold leading-relaxed">
                    Water bottle returned to owner.
                  </p>
                  <p className="text-zinc-400 text-[9px] font-bold">10 mins ago by Admin Sys</p>
                </div>
                ...
                <div className="relative space-y-1">
                  ...
                  <p className="text-zinc-400 text-[9px] font-bold">45 mins ago by Staff Member</p>
                </div>
